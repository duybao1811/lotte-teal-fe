      ...
      >
        ...
        <div className="text-white  text-center absolute inset-0 flex flex-col items-center justify-center p-4">
          <motion.h3
            ...
            className={clsx('font-extrabold', active ? 'text-3.5xl' : 'text-2.5xl')}
          >
            {title}
          </motion.h3>
          <AnimatePresence>
            {active ? (
              <motion.p
                key="content"
                className="whitespace-pre-line absolute text-0.5xl font-bold"
            ...
            {active ? (
              ...
              >
                <Link
                  href={'/'}
                  className={
                    'border border-white rounded-full font-extrabold text-lg flex items-center justify-center min-w-[190px] min-h-[40px]'
                  }
                >
                  VIEW MORE
                </Link>
