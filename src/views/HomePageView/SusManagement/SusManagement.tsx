...
import SusManagementEnvironment from '@/assets/images/sus-management/environment.webp';
import SusManagementSafetyQuality from '@/assets/images/sus-management/safety-quality.webp';
import SusManagementEthicsCompliance from '@/assets/images/sus-management/ethics-compliance.webp';
import SusManagementSocialContribution from '@/assets/images/sus-management/social-contribution.webp';
  ...
  () => import('@/views/HomePageView/SusManagement/SusManagementBgAnimation'),
  {
    ...
    loading: () => (
      <div className="absolute inset-0 -z-1">
        <Image
          src={SusManagementEnvironment.src}
          alt="fallback"
          fill
...
export const susManagementData = [
  {
    ...
    image: SusManagementEnvironment.src,
  },
  {
    title: '안전·품질경영',
    content: '가나다라가나다라가나다라가나다라\n' + '가나다라가나다라가나다라',
    image: SusManagementSafetyQuality.src,
  },
  {
    title: '윤리·준법경영',
    content: '가나다라가나다라가나다라가나다라가나다라가나다라',
    image: SusManagementEthicsCompliance.src,
  },
  {
    title: '사회공헌 & 동반성장',
    content: '가나다라가나다라가나다라가나다라가나다라가나다라',
    image: SusManagementSocialContribution.src,
  },
];
