...
import ScrollDownIcon from '@/views/HomePageView/Banner/ScrollDownIcon';
...
export default function PageSections() {
  return (
    <div className="relative overflow-hidden md:h-[90vh] h-[80vh]">
      ...
      <div className="custom-pagination absolute top-1/2 left-10 -translate-y-1/2 flex flex-col gap-3 z-10"></div>
