...
import AluminumFoilBG from '@/assets/images/business/AluminumFoil.webp';
import PrintingPackagingBG from '@/assets/images/business/PrintingPackaging.webp';
import ResearchFieldsBG from '@/assets/images/business/ResearchFields.webp';
import BgCan from '@/assets/images/business/Can.webp';
import CorrugatedBoxBG from '@/assets/images/business/CorrugatedBox.webp';
import HouseholdGoodsBG from '@/assets/images/business/HouseholdGoods.webp';
import NewBusinessBG from '@/assets/images/business/NewBusiness.webp';
    ...
    <div className="w-full" ref={sectionRef}>
      ...
      {isTablet ? (
        <>
          ...
          />
          <BusinessCarouselScroll data={mockData} onChangeActive={setItemActive} />
        </>
      ) : (
        <>
          <BusinessTabs
